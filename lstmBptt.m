function [ H, states, J, Theta_g ] = lstmBptt(X, states, Theta, Y, ...
                                              lambda, dropout)
%LSTMBPTT LSTM forward and backward pass with softmax activation, L2 
%          regularization, and dropout for a discrete sequence
% Input Arguments:
...
% Return if expected outputs not specified
if nargin < 4
    J = -1;
    return
end
