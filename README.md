# Machine Learning
A collection of machine learning operations in MATLAB. Still very much under construction.

### Contrived Example
A 5-layer convolutional network with ELU activations. See [examples/conv2dExample.m](examples/conv2dExample.m)
